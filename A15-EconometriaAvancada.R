#Aula 14 - Quebra Estrural e Bolhas ~ Econometria Avancada

remove.packages("readxl")
install.packages("readxl", dependencies = T) #Instalando pacotes
install.packages("strucchange")               #Instalando pacotes 
remove.packages("aTSA")                       #revome Pacotes Desnecesarios evitar erros e reinstalar
install.packages("aTSA", dependencies = T)  #Instalando pacotes

library(strucchange) #Ler Pacotes
library(readxl)      #Ler Pacotes
library(aTSA)         #Ler Pacotes
library(tseries)       #Ler Pacotes
library("urca")         #Ler Pacotes
